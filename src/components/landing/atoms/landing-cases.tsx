...
const OPEN_SLOTS: readonly {
  eyebrow: Record<Locale, string>;
  title: Record<Locale, string>;
  text: Record<Locale, string>;
}[] = [
  {
    eyebrow: { lv: "Nākamais stāsts", en: "Next story" },
    title: { lv: "Šeit varētu būt jūsu uzņēmums", en: "Your company could be here" },
    text: {
      lv: "Pievienojieties pilotam un padariet komandas neredzamo darbu izmērāmu",
      en: "Join the pilot and make your team's invisible work measurable",
    },
  },
  {
    eyebrow: { lv: "Atvērta vieta", en: "Open slot" },
    title: { lv: "Jūsu pilotprojekts", en: "Your pilot project" },
    text: {
      lv: "Sākam ar jūsu komandas situāciju un izveidojam praktisku risinājumu",
      en: "We start from your team's situation and build a practical solution",
    },
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full px-4 md:px-8">
        <Reveal as="header" className="mb-8 max-w-3xl md:mb-16">
          <div className="mb-3 inline-block">
            <SectionBadge>{t("cases.badge")}</SectionBadge>
          </div>
          <h2 className="text-landing-h2 text-black">
            <WaveHeading tone="dark">{t("cases.heading")}</WaveHeading>
          </h2>
        </Reveal>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {OPEN_SLOTS.map((slot, index) => (
            <Reveal key={slot.title.lv} delay={0.08 * (index + 1)}>
              <div
